...
# Import
our_DMPs <- as.data.frame(read_xlsx("Users/kirahoeffler/OneDrive - University of Bergen/PhD/24_Case_Control_project/Export_SAFE/output_meta/Tables/DMPs_CaseCtrl_limma_signif_BACON_BH_extended.xlsx"))
...
write_xlsx(our_DMPs, path = "Users/kirahoeffler/OneDrive - University of Bergen/PhD/24_Case_Control_project/Saliva_brain/Permutation_test/DMPs_meta.xlsx")
