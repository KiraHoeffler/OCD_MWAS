...
our_DMRs <- as.data.frame(read_xlsx("Users/kirahoeffler/OneDrive - University of Bergen/PhD/24_Case_Control_project/Export_SAFE/output_M/Tables/DMRs_CaseCtrl_5CtrlPCs_2AncPCs_extended.xlsx"))
...
write_xlsx(our_DMRs, path = "Users/kirahoeffler/OneDrive - University of Bergen/PhD/24_Case_Control_project/Saliva_brain/Permutation_test/DMRs_males.xlsx")
