...
beta_path <- "S:/Project/WP-epigenetics/04_Pipeline_PhaseI/output/RData/beta_final_combined_X_females.RData"
Mvalues_path <- "S:/Project/WP-epigenetics/04_Pipeline_PhaseI/output/RData/Mvalues_final_combined_X_females.RData"
...
# MAKE FOLDERS
if (!dir.exists("output_F/Figures/DMRs")) dir.create("output_F/Figures/DMRs")
if (!dir.exists("output_F/Figures/DMRs/raw")) dir.create("output_F/Figures/DMRs/raw")
if (!dir.exists("output_F/Figures/DMRs/combined")) dir.create("output_F/Figures/DMRs/combined")

if (!dir.exists("output_F/Figures/DMPs")) dir.create("output_F/Figures/DMPs")
if (!dir.exists("output_F/Figures/DMPs/raw")) dir.create("output_F/Figures/DMPs/raw")
if (!dir.exists("output_F/Figures/DMPs/combined")) dir.create("output_F/Figures/DMPs/combined")

if (!dir.exists("output_F/Figures/mQTL")) dir.create("output_F/Figures/mQTL")
if (!dir.exists("output_F/Figures/mQTL/combined")) dir.create("output_F/Figures/mQTL/combined")
if (!dir.exists("output_F/Figures/mQTL_DNAm")) dir.create("output_F/Figures/mQTL_DNAm")

if (!dir.exists("output_F/Figures/Sex")) dir.create("output_F/Figures/Sex")
...
#samplesheet
samples <- as.data.frame(read_xlsx("output_F/Tables/Final_samplesheet_CaseCtrl.xlsx"))
mean(samples$Pre_YB_Sum, na.rm = TRUE) #26.09459
sd(samples$Pre_YB_Sum, na.rm = TRUE) #4.127359
samples$Diagnosis <- ifelse(samples$Case_Control == "Case", "OCD", "CTRL")

#DMPS
load("output_F/RData/DMPs_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.RData")
...
lambda(DMPs$P.Value)#1.079608

# CORRECT FOR MULTIPLE TESTING
DMPs$adj_p_BH <- p.adjust(DMPs$P.Value, method = "BH")

# EXPORT
save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_BACON.RData")

pdf(file = "output_F/Figures/QQplot_CaseCtrl_15CTRLPCs_2AncPCs_limma_BACON.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplot_CaseCtrl_15CTRLPCs_2AncPCs_limma_BACON.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
save(DMPs_anno, file = "output_F/RData/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_anno_BACON.RData")
rm(DMPs)

# EXPORT SIGNIFICANT RESULTS
signif_DMPs_BH <- DMPs_anno[which(DMPs_anno$adj_p_BH <= 0.05),]
nrow(signif_DMPs_BH) #1
write_xlsx(signif_DMPs_BH, path = "output_F/Tables/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_signif_BACON_BH.xlsx")
save(signif_DMPs_BH, file = "output_F/RData/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_signif_BACON_BH.RData")
...
combp_result <- as.data.frame(read_xlsx("output_F/Tables/combp_CaseCtrl_Females.xlsx"))

combp_sign <- adapt_combp(combp_result, DMPs_anno, anno_upd, nr_CpGs = 3, nr_signif_CpGs = 3, signif_proportion = 0.5)
#"significant DMRs before filtering step: 27"
#"significant DMRs after filtering: 14"

write_xlsx(combp_sign, "output_F/Tables/DMRs_combp_CaseCtrl_15CtrlPCs_2AncPCs_filtered_BACON.xlsx")
...
# MANHATTAN PLOT
Manhattan_plot <- Manhattan(DMPs_anno, "F", "BH", combp_sign, min_DMR_p, min_sign)

ggsave("output_F/Figures/Manhattan_CaseCtrl_15CtrlPCs_2AncPCs.svg", Manhattan_plot, units = "cm", width = 13, height = 9, dpi = 300)
ggsave("output_F/Figures/Manhattan_CaseCtrl_15CtrlPCs_2AncPCs.pdf", Manhattan_plot, units = "cm", width = 13, height = 9, dpi = 300)
ggsave("output_F/Figures/Manhattan_CaseCtrl_15CtrlPCs_2AncPCs.png", Manhattan_plot, units = "cm", width = 13, height = 9, dpi = 400)
...
for (j in c(1:nrow(combp_sign))){
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_DENS.svg"), Dens_plot, units = "cm", width = 13, height = 12, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_DENS.pdf"), Dens_plot, units = "cm", width = 13, height = 12, dpi = 400) 
  save(Dens_plot, max_value, OR_bottom20, OR_top20,bottom20_thresh, top20_thresh, DMR_categ,   
       file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_DENS.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_CATEG.pdf"), Categ_plot, units = "cm", width = 7, height = 10.5, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_CATEG.svg"), Categ_plot, units = "cm", width = 7, height = 10.5, dpi = 400)
  save(Categ_plot, df_summary, GeneString, file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_CATEG.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_combp.pdf"), combp_plot, units = "cm", width = 14, height = 10, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_combp.svg"), combp_plot, units = "cm", width = 14, height = 10, dpi = 400)
  save(combp_plot, file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_combp.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_CPG.svg"), cpg_plot, units = "cm", width = 17, height = 13.5, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_CPG.pdf"), cpg_plot, units = "cm", width = 17, height = 13.5, dpi = 400)       
  save(cpg_plot, file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_CPG.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_TRACK.svg"), cpg_line_plot, units = "cm", width = 20, height = 13.5, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_TRACK.pdf"), cpg_line_plot, units = "cm", width = 20, height = 13.5, dpi = 400)       
  save(cpg_line_plot, GeneString, file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_TRACK.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_TRACK_DIFF.svg"), cpg_line_plot_diff, units = "cm", width = 20, height = 10, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/DMR_CaseCtrl_", GeneString2, "_TRACK_DIFF.pdf"), cpg_line_plot_diff, units = "cm", width = 20, height = 10, dpi = 400)       
  save(cpg_line_plot_diff, GeneString, file = paste0("output_F/Figures/DMRs/raw/DMR_CaseCtrl_", GeneString2, "_TRACK_DIFF.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMRs/combined/DMR_CaseCtrl_", GeneString2, "_COMB.svg"), layout, units = "cm", width = 22, height = 24, dpi = 400)
  ggsave(paste0("output_F/Figures/DMRs/combined/DMR_CaseCtrl_", GeneString2, "_COMB.pdf"), layout, units = "cm", width = 22, height = 24, dpi = 400)       
...
write_xlsx(combp_sign, path = "output_F/Tables/DMRs_CaseCtrl_15CtrlPCs_2AncPCs_extended.xlsx")
save(combp_sign, file = "output_F/RData/DMRs_CaseCtrl_15CtrlPCs_2AncPCs_extended.RData")
...
for (j in c(1:nrow(signif_DMPs_BH))){
  ...
  ggsave(paste0("output_F/Figures/DMPs//DMP_CaseCtrl_", Gene2, "_DENS.svg"), Dens_plot, units = "cm", width = 13, height = 12, dpi = 400)
  ggsave(paste0("output_F/Figures/DMPs/DMP_CaseCtrl_", Gene2, "_DENS.pdf"), Dens_plot, units = "cm", width = 13, height = 12, dpi = 400) 
  save(Dens_plot, max_value, OR_bottom20, OR_top20,bottom20_thresh, top20_thresh, CpG_categ, cgID, Gene,  
       file = paste0("output_F/Figures/DMPs/raw/DMP_CaseCtrl_", cgID, "_", Gene2, "_DENS.RData"))
  ...
  Categ_plot <- ggplot(CpG_categ, aes(x = Diagnosis, y = DMPmethylation, fill = Diagnosis)) +
    ...
    theme(plot.title = element_text(hjust = 0.5))
  Categ_plot
  ggsave(paste0("output_F/Figures/DMPs/DMP_CaseCtrl_", cgID, "_", Gene2, "_CATEG.pdf"), Categ_plot, units = "cm", width = 7, height = 10.5, dpi = 400)
  ggsave(paste0("output_F/Figures/DMPs/DMP_CaseCtrl_", cgID, "_", Gene2, "_CATEG.svg"), Categ_plot, units = "cm", width = 7, height = 10.5, dpi = 400)
  save(Categ_plot, df_summary, cgID, Gene, file = paste0("output_F/Figures/DMPs/raw/DMP_CaseCtrl_", cgID, "_", Gene2, "_CATEG.RData"))
  ...
  ggsave(paste0("output_F/Figures/DMPs/combined/DMP_CaseCtrl_", cgID, "_", Gene2, "_COMB.svg"), layout, units = "cm", width = 19, height = 13, dpi = 400)
  ggsave(paste0("output_F/Figures/DMPs/combined/DMP_CaseCtrl_", cgID, "_", Gene2, "_COMB.pdf"), layout, units = "cm", width = 19, height = 13, dpi = 400)       
...
# EXPORT DMR TABLE WITH ADDED ORs
write_xlsx(signif_DMPs_BH, path = "output_F/Tables/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_signif_BACON_BH_extended.xlsx")
save(signif_DMPs_BH, file = "output_F/RData/DMPs_CaseCtrl_15CTRLPCs_2AncPCs_limma_signif_BACON_BH_extended.RData")
...
save(unmedicated_result, file = "output_F/RData/Sensitivity_unmedicated.RData")
write_xlsx(unmedicated_result, path = "output_F/Tables/Sensitivity_unmedicated.xlsx")
...
save(noComorb_result, file = "output_F/RData/Sensitivity_noComorb.RData")
write_xlsx(noComorb_result, path = "output_F/Tables/Sensitivity_noComorb.xlsx")
...
write.table(Matt_translation_filtered[, c("Resp_nr", "Resp_nr")], file = "S:/Project/WP-genetics/05_Kira_mQTL/5_Clumping/Females_filtered_sampleIDs.txt",
            row.names = FALSE, col.names = FALSE, quote = FALSE)

stop("PERFORM PCA IN PLINK. This is not an error.")

snpsprobe_PCAscores <- read.table("S:/Project/WP-genetics/05_Kira_mQTL/5_PCA_results/CaseCtrl/PCA_result_Females.eigenvec", header = FALSE)
...
write_xlsx(mQTL_results_comb_sign, path = "output_F/Tables/mQTL_sign.xlsx")
save(mQTL_results_comb_sign, file = "output_F/RData/mQTL_sign.RData")

write_xlsx(mQTL_results_comb, path = "output_F/Tables/mQTL.xlsx")
save(mQTL_results_comb, file = "output_F/RData/mQTL.RData")
...
write.table(summary_stats_plink, "S:/Project/WP-genetics/05_Kira_mQTL/5_Clumping/CaseCtrl/association_results_Females.assoc",
            quote = FALSE, row.names = FALSE, sep = "\t")

stop("Clumping - not an error")
# 22 clumps formed from 316 top variants

clumped_snps <- read.table("S:/Project/WP-genetics/05_Kira_mQTL/5_Clumping/CaseCtrl/clumped_snps_final_Females.clumped", 
...
write_xlsx(mQTL_results_comb_clumped, path = "output_F/Tables/mQTL_sign_clumped.xlsx")
save(mQTL_results_comb_clumped, file = "output_F/RData/mQTL_sign_clumped.RData")

table(mQTL_results_comb_clumped$DMR)
#ADAMTS2      ARHGEF17    cg01188427 DYNLT4;BTBD19     EEF1A1P49  FAM120B;DLL1     LINC00511    MIR21;VMP1        NDUFS7         PGBD5 
#2             1             2             2             2             3             1             2             1             5 
#RIN1 
#1  
...
for (j in c(1:nrow(mQTL_results_comb_clumped))){
  ...
  #save
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.svg"), DNAm_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.pdf"), DNAm_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)       
  save(DNAm_SNP_plot, diff, file = paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.RData"))
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, ".svg"), Diagnosis_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, ".pdf"), Diagnosis_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)       
  save(Diagnosis_SNP_plot, df_percentage, file = paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, ".RData"))
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_count.svg"), Diagnosis_SNP_count_plot, units = "cm", width = 6.5, height = 11, dpi = 400)
  ggsave(paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_count.pdf"), Diagnosis_SNP_count_plot, units = "cm", width = 6.5, height = 11, dpi = 400)       
  save(Diagnosis_SNP_count_plot, df_percentage, file = paste0("output_F/Figures/mQTL/DMR_CaseCtrl_", Region_Name2, "_", snp, "_count.RData"))
  ...
  ggsave(paste0("output_F/Figures/mQTL/combined/DMR_CaseCtrl_", Region_Name2, "_", snp, "_COMB.svg"), layout, units = "cm", width = 19, height = 12, dpi = 400)
  ggsave(paste0("output_F/Figures/mQTL/combined/DMR_CaseCtrl_", Region_Name2, "_", snp, "_COMB.pdf"), layout, units = "cm", width = 19, height = 12, dpi = 400)       
...
write.table(summary_stats_plink, "S:/Project/WP-genetics/05_Kira_mQTL/5_Clumping/CaseCtrl/association_results_DNAm_Females.assoc",
            quote = FALSE, row.names = FALSE, sep = "\t")

stop("Clumping - not an error")
# 23 clumps formed from 316 top variants

clumped_snps_DNAm <- read.table("S:/Project/WP-genetics/05_Kira_mQTL/5_Clumping/CaseCtrl/clumped_snps_final_DNAm_Females.clumped", 
                           header = TRUE, stringsAsFactors = FALSE)

mQTL_results_comb_clumped_DNAm <- mQTL_results_comb_sign[which(mQTL_results_comb_sign$SNP %in% clumped_snps_DNAm$SNP), ]

write_xlsx(mQTL_results_comb_clumped_DNAm, path = "output_F/Tables/mQTL_sign_clumped_DNAm.xlsx")
save(mQTL_results_comb_clumped_DNAm, file = "output_F/RData/mQTL_sign_clumped_DNAm.RData")
...
for (j in c(1:nrow(mQTL_results_comb_clumped_DNAm))){
  ...
  #save
  ggsave(paste0("output_F/Figures/mQTL_DNAm/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.svg"), DNAm_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)
  ggsave(paste0("output_F/Figures/mQTL_DNAm/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.pdf"), DNAm_SNP_plot, units = "cm", width = 6.5, height = 11, dpi = 400)       
  save(DNAm_SNP_plot, diff, file = paste0("output_F/Figures/mQTL_DNAm/DMR_CaseCtrl_", Region_Name2, "_", snp, "_DNAm_SNP.RData"))
}
...
LD_SNPs <- as.data.frame(read_xlsx("output_F/Tables/LD_CaseCtrl_Females_rs117335099.xlsx"))
...
for (j in c(1:nrow(DMRs_DMPs))){
  ...
  if(lm_p_value < 0.05){
    ...
    DMR_contin$Sex[which(DMR_contin$Sex == "F")] <- "female"
    ...
    ggsave(paste0("output_F/Figures/Sex/DMR_CaseCtrl_", Region_Name2, "_sex.pdf"), Sex_plot, units = "cm", width = 12, height = 9.5, dpi = 400)
    ggsave(paste0("output_F/Figures/Sex/DMR_CaseCtrl_", Region_Name2, "_sex.svg"), Sex_plot, units = "cm", width = 12, height = 9.5, dpi = 400)
    save(Sex_plot, file = paste0("output_F/Figures/Sex/DMR_CaseCtrl_", Region_Name2, "_sex.RData"))
...
write_xlsx(sex_results, path = "output_F/Tables/Sex.xlsx")
save(sex_results, file = "output_F/RData/Sex.RData")
