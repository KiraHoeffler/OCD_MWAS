...
Strom <- read.table("Users/kirahoeffler/OneDrive - University of Bergen/PhD/14_Downloads/SummaryStatistics/OCD_Strom/daner_OCD_full_wo23andMe_190522", header = TRUE)
...
write_xlsx(our_DMRs, path = "Users/kirahoeffler/OneDrive - University of Bergen/PhD/24_Case_Control_project/Comparison_GWAS/Permutation_test/DMR_females.xlsx")
