...
# Import
our_DMRs <- as.data.frame(read_xlsx("OneDrive - University of Bergen/PhD/24_Case_Control_project/Export_SAFE/output_M/Tables/DMRs_CaseCtrl_5CtrlPCs_2AncPCs_extended.xlsx"))
...
write_xlsx(our_DMRs, path = "OneDrive - University of Bergen/PhD/24_Case_Control_project/Comparison_GWAS/Permutation_test/DMR_males.xlsx")
