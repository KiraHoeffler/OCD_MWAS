...
#New Folders
if (!dir.exists("output_CT/")) dir.create("output_CT/")
if (!dir.exists("output_CT/Tables/")) dir.create("output_CT/Tables/")
if (!dir.exists("output_CT/Figures/")) dir.create("output_CT/Figures/")
if (!dir.exists("output_CT/Figures/CelltypeProportions")) dir.create("output_CT/Figures/CelltypeProportions")


# LOAD & ADAPT SAMPLESHEET 
samples_F <- as.data.frame(read_excel("output_F/Tables/Final_samplesheet_CaseCtrl.xlsx"))
samples_M <- as.data.frame(read_excel("output_M/Tables/Final_samplesheet_CaseCtrl.xlsx"))
...
# FUNCTIONS
source("General/Functions/PCAs_for_model.R")
source("General/Functions/cell_prop_analyses.R")
...
# create empty df for results
comb_results_Sex_ii <- as.data.frame(matrix(data = NA, nrow = 0, ncol = 6))
colnames(comb_results_Sex_ii) <- c("Cell_type", "Estimate_Sex_ii", "Std_Error_Sex_ii", "t_value_Sex_ii", "p_value_Sex_ii")
...
for (i in c(1:length(cell_type_vector))){
  ...
  results <- data.frame(Cell_type = cell_type_vector[i],
                        Estimate_Sex_ii = model_summary$coefficients["DiagnosisOCD:SexM", "Estimate"],
                        Std_Error_Sex_ii = model_summary$coefficients["DiagnosisOCD:SexM", "Std. Error"],
                        t_value_Sex_ii = model_summary$coefficients["DiagnosisOCD:SexM", "t value"],
                        p_value_Sex_ii = model_summary$coefficients["DiagnosisOCD:SexM", "Pr(>|t|)"])
  
  comb_results_Sex_ii <- rbind(comb_results_Sex_ii, results)
...
write_xlsx(comb_results, path = "output_CT/Tables/CellTypes_CaseCtrl.xlsx")

comb_results_Sex_ii$adj_p_value_Sex_ii <- comb_results_Sex_ii$p_value_Sex_ii * M_eff
write_xlsx(comb_results_Sex_ii, path = "output_CT/Tables/CellTypes_CaseCtrl_Sex_interaction.xlsx")
...
#EXPORT
write_xlsx(summary_table, path = "output_CT/Tables/Cell_type_proportions.xlsx")
...
# EXPORT PLOT
ggsave("output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi.pdf", celltype_prop_hepi_plot, units = "cm", width = 11, height = 8, dpi = 400)
ggsave("output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi.svg", celltype_prop_hepi_plot, units = "cm", device = "svg",  width = 11, height = 8, dpi = 400)
save(celltype_prop_hepi_plot, file = "output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi.RData")
...
ggsave("output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi_violin.pdf", Hepi_violin_plot, units = "cm", width = 15, height = 12, dpi = 400)
ggsave("output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi_violin.svg", Hepi_violin_plot, units = "cm", device = "svg", width = 15, height = 12, dpi = 400)
save(Hepi_violin_plot, file = "output_CT/Figures/CelltypeProportions/Cell_type_proportions_hepi_violin.RData")
...
for (i in c(1:length(cell_type_vector))){
  ...
  ggsave(paste0("output_CT/Figures/CelltypeProportions/CellTypes_", cell_type, "_CaseCtrl.pdf"), plot, units = "cm", width = 6, height = 9, dpi = 400)
  ggsave(paste0("output_CT/Figures/CelltypeProportions/CellTypes_", cell_type, "_CaseCtrl.svg"), plot, units = "cm", width = 6, height = 9, dpi = 400)
  save(plot, height, span, file = paste0("output_CT/Figures/CelltypeProportions/CellTypes_", cell_type, "_CaseCtrl.RData"))
}


# COMBINED FIGURE
load("output_CT/Figures/CelltypeProportions/CellTypes_Neutro_CaseCtrl.RData")
CellTypesNeutro <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_Mono_CaseCtrl.RData")
CellTypesMono <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_CD4T_CaseCtrl.RData")
CellTypesCD4T <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_NK_CaseCtrl.RData")
CellTypesNK <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_Epi_CaseCtrl.RData")
CellTypesEpi <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_B_CaseCtrl.RData")
CellTypesB <- plot
load("output_CT/Figures/CelltypeProportions/CellTypes_Fib_CaseCtrl.RData")
CellTypesFib <- plot
...
ggsave(paste0("output_CT/Figures/CelltypeProportions/Cell_type_prop_categ_COMB.svg"), layout, units = "cm", width = 35, height = 25, dpi = 400)
ggsave(paste0("output_CT/Figures/CelltypeProportions/Cell_type_prop_categ_COMB.pdf"), layout, units = "cm", width = 35, height = 25, dpi = 400)       
...
ggsave(paste0("output_CT/Figures/CelltypeProportions/Variation_COMB.svg"), layout, units = "cm", width = 26, height = 13, dpi = 400)
ggsave(paste0("output_CT/Figures/CelltypeProportions/Variation_COMB.pdf"), layout, units = "cm", width = 26, height = 13, dpi = 400)       
