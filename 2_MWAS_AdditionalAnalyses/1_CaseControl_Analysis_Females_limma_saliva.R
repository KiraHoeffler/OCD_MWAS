...
# MAKE FOLDERS
if (!dir.exists("output_F")) dir.create("output_F")
if (!dir.exists("output_F/Figures")) dir.create("output_F/Figures")
if (!dir.exists("output_F/Figures/QQplots")) dir.create("output_F/Figures/QQplots")
if (!dir.exists("output_F/Tables")) dir.create("output_F/Tables")
if (!dir.exists("output_F/RData")) dir.create("output_F/RData")
...
load(paste0(dir_gen, "/output/RData/Mvalues_final_combined_X_females.RData"))
load(paste0(dir_gen, "/output/RData/beta_final_combined_X_females.RData"))
...
# SELECT SAMPLES
samples <- samplesheet[which(samplesheet$Sex == "F" & is.na(samplesheet$Transgender)), ]
...
print(paste0("Nr of Females included: ", length(samples$Basename))) #572
write_xlsx(samples, path = "output_F/Tables/Final_samplesheet_CaseCtrl.xlsx")
...
write_xlsx(vif_obj, path = "output_F/Tables/VIF_CaseCtrl_Females.xlsx")
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_2CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_5CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_10CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_2CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_5CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_10CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_15CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_2CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_2CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_5CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_5CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_10CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_10CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output_F/RData/DMPs_CaseCtrl_Females_15CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output_F/Figures/QQplots/QQplot_CaseCtrl_Females_15CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT LAMBDA TABLE
write_xlsx(lambda_table, path = "output_F/Tables/Lambda_CaseCtrl_Females_limma.xlsx")
