...
#New Folders
if (!dir.exists("output/Tables/CelltypeProportions_noMedic")) dir.create("output/Tables/CelltypeProportions_noMedic")
if (!dir.exists("output/Figures/CelltypeProportions_noMedic")) dir.create("output/Figures/CelltypeProportions_noMedic")


# LOAD SAMPLESHEET 
samplesheet <- as.data.frame(read_excel("output/Tables/Final_samplesheet_CaseCtrl.xlsx"))
...
# SAMPLESHEET
samples <- samplesheet[which((samplesheet$Diagnosis == "OCD" & samplesheet$Psychoactive_medicine == "N") | samplesheet$Diagnosis == "CTRL"), ]
...
write_xlsx(comb_results, path = "output/Tables/CelltypeProportions_noMedic/CellTypes_CaseCtrl.xlsx")
...
#EXPORT
write_xlsx(summary_table, path = "output/Tables/CelltypeProportions_noMedic/Cell_type_proportions.xlsx")
...
# EXPORT PLOT
ggsave("output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi.pdf", celltype_prop_hepi_plot, units = "cm", width = 11, height = 8, dpi = 400)
ggsave("output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi.svg", celltype_prop_hepi_plot, units = "cm", device = "svg",  width = 11, height = 8, dpi = 400)
save(celltype_prop_hepi_plot, file = "output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi.RData")
...
ggsave("output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi_violin.pdf", Hepi_violin_plot, units = "cm", width = 15, height = 12, dpi = 400)
ggsave("output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi_violin.svg", Hepi_violin_plot, units = "cm", device = "svg", width = 15, height = 12, dpi = 400)
save(Hepi_violin_plot, file = "output/Figures/CelltypeProportions_noMedic/Cell_type_proportions_hepi_violin.RData")
...
for (i in c(1:length(cell_type_vector))){
  ...
  ggsave(paste0("output/Figures/CelltypeProportions_noMedic/CellTypes_", cell_type, "_CaseCtrl.pdf"), plot, units = "cm", width = 6, height = 9, dpi = 400)
  ggsave(paste0("output/Figures/CelltypeProportions_noMedic/CellTypes_", cell_type, "_CaseCtrl.svg"), plot, units = "cm", width = 6, height = 9, dpi = 400)
  save(plot, height, span, file = paste0("output/Figures/CelltypeProportions_noMedic/CellTypes_", cell_type, "_CaseCtrl.RData"))
}


# COMBINED FIGURE
load("output/Figures/CelltypeProportions_noMedic/CellTypes_Neutro_CaseCtrl.RData")
CellTypesNeutro <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_Mono_CaseCtrl.RData")
CellTypesMono <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_CD4T_CaseCtrl.RData")
CellTypesCD4T <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_NK_CaseCtrl.RData")
CellTypesNK <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_Epi_CaseCtrl.RData")
CellTypesEpi <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_B_CaseCtrl.RData")
CellTypesB <- plot
load("output/Figures/CelltypeProportions_noMedic/CellTypes_Fib_CaseCtrl.RData")
CellTypesFib <- plot
...
ggsave(paste0("output/Figures/CelltypeProportions_noMedic/Cell_type_prop_categ_COMB.svg"), layout, units = "cm", width = 35, height = 25, dpi = 400)
ggsave(paste0("output/Figures/CelltypeProportions_noMedic/Cell_type_prop_categ_COMB.pdf"), layout, units = "cm", width = 35, height = 25, dpi = 400)       
...
ggsave(paste0("output/Figures/CelltypeProportions_noMedic/Variation_COMB.svg"), layout, units = "cm", width = 26, height = 13, dpi = 400)
ggsave(paste0("output/Figures/CelltypeProportions_noMedic/Variation_COMB.pdf"), layout, units = "cm", width = 26, height = 13, dpi = 400)       
