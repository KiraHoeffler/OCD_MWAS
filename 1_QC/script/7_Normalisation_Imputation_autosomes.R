...
filtered_samplesheet$Ancestry <- as.factor(filtered_samplesheet$Ancestry)
...
#Ancestry
pc12_Anc_classif <- qplot(x=PC1, y=PC2, data=pca_scores, colour = filtered_samplesheet$Ancestry) + th + th_transparent + 
  theme(legend.position = "none")
pc23_Anc_classif <- qplot(x=PC2, y=PC3, data=pca_scores, colour = filtered_samplesheet$Ancestry) + th + th_transparent + 
  theme(legend.position = "none")
pc34_Anc_classif <- qplot(x=PC3, y=PC4, data=pca_scores, colour = filtered_samplesheet$Ancestry) + th + th_transparent + 
  labs(color = "Ancestry")
